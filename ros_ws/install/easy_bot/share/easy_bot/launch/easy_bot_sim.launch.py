...
def generate_launch_description():
    ...
    action_control_node = launch_ros.actions.Node(
        ...
        parameters=[
            ...
            os.path.join(urdf_package_path, 'config', 'easy_bot_controller.yaml')
        ],
        output='screen'
    )
    ...
    easy_bot_controller_spawner = launch_ros.actions.Node(
        package='controller_manager',
        executable='spawner',
        arguments=['easy_bot_controller'],
    )
